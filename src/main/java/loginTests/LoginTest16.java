 ...
 * 4.adım e-mail adresi Büyük harfle girilir
 * 5.adım şifre sıfırlama butonuna tıklanır
 * 6.Sistem harf duyarsız çalışmalı, büyük/küçük harfe dikkat etmemeli.
...
public class LoginTest16 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            resetPasswordPage.email_Input("GAMZEECLSR@GMAİL.COM", false); // E-posta alanı boş bırakılır
