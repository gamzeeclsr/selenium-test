 ...
 * 4.adım e-mail adresi başında ve sonunda boşluk bırakılır
 * 5.adım şifre sıfırlama butonuna tıklanır
 * 6.Sistem boşlukları temizleyip işleme devam etmeli veya uyarı vermeli.
...
public class LoginTest17 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            resetPasswordPage.email_Input("  gamzeeclsr@gmail.com  ", false); // E-posta alanı boş bırakılır
