...
public class vehicletracking12 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Loginpage.enterUsername("denemeyap", false);
            Loginpage.clickContinue();
            Loginpage.enterPassword("@@@***!!!", false);
            Loginpage.clickLogin();

            Thread.sleep(3000);
            vehicle_tracking vehicletracking = new vehicle_tracking(driver);
            vehicletracking.vtSearch("34ABC123XYZ999");
            Thread.sleep(2000);
            vehicletracking.verifyNoVehicleMarkerOnMap("34ABC123XYZ999");
